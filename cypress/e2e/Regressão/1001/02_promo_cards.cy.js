...
describe("Validar cards de promoção", () => {
  ...
  // });
  // it.only("Deve validar o link do 2º card de promoção e redirecionar para a página de login", () => {
  ...
  // it.only("Deve validar o link do 4º card de promoção e redirecionar para a página de login", () => {
